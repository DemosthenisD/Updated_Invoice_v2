...
st.sidebar.page_link('pages/1_record.py',         label="RECORD",         icon="📓")    
st.sidebar.page_link('pages/2_add_new_record.py', label="ADD NEW RECORD", icon="✒️")  
...
def main():
    if 'username' in st.session_state:
        ...
        st.error("There's some issue, Please go back to auth page!")
        if st.button("Auth"):
            switch_page('app')
